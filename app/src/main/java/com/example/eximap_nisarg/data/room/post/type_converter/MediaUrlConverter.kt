package com.example.eximap_nisarg.data.room.post.type_converter
...
class MediaUrlConverter {
    ...
    @TypeConverter
    fun fromMediaList(mediaList: MutableList<MediaUrl>): String {
        return gson.toJson(mediaList)
    }

    @TypeConverter
    fun toMediaList(mediaListJson: String): MutableList<MediaUrl> {
